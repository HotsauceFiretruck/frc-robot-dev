...
public class DriveSystem
{
    ...
    */
    private static final DifferentialDrive wheelsMotor2 = new DifferentialDrive(new PWMVictorSPX(2), new PWMVictorSPX(1));
    private static final DifferentialDrive wheelsMotor1 = new DifferentialDrive(new PWMVictorSPX(3), new PWMVictorSPX(0)); 
